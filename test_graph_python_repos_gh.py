#Testing graph_python_repos_gh
#unittest
import unittest
import graph_python_repos_gh as gpr
...
class PythonReposTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.r = gpr.get_response()
        self.repo_dicts = gpr.get_repo_dicts(self.r)
        self.repo_dict = self.repo_dicts[0]
        self.repo_links, self.stars, self.labels = gpr.get_project_data(
                self.repo_dicts)
